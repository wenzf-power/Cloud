package com.wzf.cloud.service.impl;
...
public class UserServiceImpl implements UserService {
    ...
    public void initData() {
        ...
        userList.add(User.builder().id(1L).username("wzf").password("123456").build());
        userList.add(User.builder().id(2L).username("abc").password("123456").build());
        userList.add(User.builder().id(3L).username("efg").password("123456").build());
    }
}
